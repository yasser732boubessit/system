package com.example.gestioninteractions;
import com.example.gestioninteractions.model.Item;
...
@EnableScheduling
public class GestionInteractionsApplication implements CommandLineRunner {

    private final RestTemplate restTemplate = new RestTemplate();
    private final String replyServiceUrl = "http://localhost:8082/reply";

    public static void main(String[] args) {
        SpringApplication.run(GestionInteractionsApplication.class, args);
    }
